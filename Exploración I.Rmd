...
age_mother_total_2 = confint(age_mother_total*100)
...
age_mother_2010_2 = confint(age_mother_2010*100)
...
age_mother_2016_2 = confint(age_mother_2016*100)
...
age_mother_2022_2 = confint(age_mother_2022*100)
...
```{r}
#EDUC TOTAL
educ_total = svymean(~education_level_reco, design_total,na.rm=TRUE)

educ_total_1 = educ_total*100
educ_total_2 = confint(educ_total*100)
...
educ_2010_2 = confint(educ_2010*100)
...
educ_2016_2 = confint(educ_2016*100)
...
educ_2022_2 = confint(educ_2022*100)
...
```{r}
#STATUS TOTAL
status_total = svymean(~marital_status, design_total,na.rm=TRUE)

status_total_1 = status_total*100
status_total_2 = confint(status_total*100)

status_total = data.frame(status_total_1,status_total_2)
rm(status_total_1,status_total_2)

#STATUS 2010 
status_2010 = svymean(~marital_status, design_2010,na.rm=TRUE)

status_2010_1 = status_2010*100
status_2010_2 = confint(status_2010*100)

status_2010 = data.frame(status_2010_1,status_2010_2)
rm(status_2010_1,status_2010_2)

#STATUS 2016
status_2016 = svymean(~marital_status, design_2016,na.rm=TRUE)

status_2016_1 = status_2016*100
status_2016_2 = confint(status_2016*100)

status_2016 = data.frame(status_2016_1,status_2016_2)
rm(status_2016_1,status_2016_2)

#STATUS 2022 
status_2022 = svymean(~marital_status, design_2022,na.rm=TRUE)

status_2022_1 = status_2022*100
status_2022_2 = confint(status_2022*100)
...
et_total_2 = confint(et_total*100)
...
syphilis_total_2 = confint(syphilis_total*100)
...
syphilis_2010_2 = confint(syphilis_2010*100)
...
syphilis_2016_2 = confint(syphilis_2016*100)
...
syphilis_2022_2 = confint(syphilis_2022*100)
...
sti1_total_2 = confint(sti1_total*100)
...
sti1_2010_2 = confint(sti1_2010*100)
...
sti1_2016_2 = confint(sti1_2016*100)
...
sti1_2022_2 = confint(sti1_2022*100)
...
sti2_total_2 = confint(sti2_total*100)
...
sti2_2010_2 = confint(sti2_2010*100)
...
sti2_2016_2 = confint(sti2_2016*100)
...
sti2_2022_2 = confint(sti2_2022*100)
...
preg_total_2 = confint(preg_total*100)
...
preg_2010_2 = confint(preg_2010*100)
...
preg_2016_2 = confint(preg_2016*100)
...
preg_2022_2 = confint(preg_2022*100)
...
emocional_total_2 = confint(emocional_total*100)
...
emocional_2010_2 = confint(emocional_2010*100)
...
emocional_2016_2 = confint(emocional_2016*100)
...
emocional_2022_2 = confint(emocional_2022*100)
...
physical_total_2 = confint(physical_total*100)
...
physical_2010_2 = confint(physical_2010*100)
...
physical_2016_2 = confint(physical_2016*100)
...
physical_2022_2 = confint(physical_2022*100)
...
sexual_total_2 = confint(sexual_total*100)
...
sexual_2010_2 = confint(sexual_2010*100)
...
sexual_2016_2 = confint(sexual_2016*100)
...
sexual_2022_2 = confint(sexual_2022*100)
...
preg_violence_total_2 = confint(preg_violence_total*100)
...
preg_violence_2010_2 = confint(preg_violence_2010*100)
...
preg_violence_2016_2 = confint(preg_violence_2016*100)
...
preg_violence_2022_2 = confint(preg_violence_2022*100)
...
child_total_2 = confint(child_total*100)
...
child_2010_2 = confint(child_2010*100)
...
child_2016_2 = confint(child_2016*100)
...
child_2022_2 = confint(child_2022*100)
...
abo_total_2 = confint(abo_total*100)
...
abo_2010_2 = confint(abo_2010*100)
...
abo_2016_2 = confint(abo_2016*100)
...
abo_2022_2 = confint(abo_2022*100)
...
syphilis2_total_2 = confint(syphilis2_total*100)
...
syphilis2_2010_2 = confint(syphilis2_2010*100)
...
syphilis2_2016_2 = confint(syphilis2_2016*100)
...
syphilis2_2022_2 = confint(syphilis2_2022*100)
...
other_sti_total_2 = confint(other_sti_total*100)
...
other_sti_2010_2 = confint(other_sti_2010*100)
...
other_sti_2016_2 = confint(other_sti_2016*100)
...
other_sti_2022_2 = confint(other_sti_2022*100)
...
contraceptive_total_2 = confint(contraceptive_total*100)
...
contraceptive_2010_2 = confint(contraceptive_2010*100)
...
contraceptive_2016_2 = confint(contraceptive_2016*100)
...
contraceptive_2022_2 = confint(contraceptive_2022*100)
...
sexual_par_total_2 = confint(sexual_par_total*100)
...
sexual_par_2010_2 = confint(sexual_par_2010*100)
...
sexual_par_2016_2 = confint(sexual_par_2016*100)
...
sexual_par_2022_2 = confint(sexual_par_2022*100)
...
condon_use_total_2 = confint(condon_use_total*100)
...
condon_use_2010_2 = confint(condon_use_2010*100)
...
condon_use_2016_2 = confint(condon_use_2016*100)
...
condon_use_2022_2 = confint(condon_use_2022*100)
...
alcohol_total_2 = confint(alcohol_total*100)
...
alcohol_2010_2 = confint(alcohol_2010*100)
...
alcohol_2016_2 = confint(alcohol_2016*100)
...
alcohol_2022_2 = confint(alcohol_2022*100)
...
get_condon_total_2 = confint(get_condon_total*100)
...
get_condon_2010_2 = confint(get_condon_2010*100)
...
get_condon_2016_2 = confint(get_condon_2016*100)
...
get_condon_2022_2 = confint(get_condon_2022*100)
...
hiv_screening_total_2 = confint(hiv_screening_total*100)
...
hiv_screening_2010_2 = confint(hiv_screening_2010*100)
...
hiv_screening_2016_2 = confint(hiv_screening_2016*100)
...
hiv_screening_2022_2 = confint(hiv_screening_2022*100)
