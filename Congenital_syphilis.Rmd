...
Nuevamente se excluye el valor de Barranca en 2014 por ser un valor extremo
...
ggplot(d14_d22, aes(x = rate, y = NOMBDEP)) +
  ...
  xlab("Cases of congenital syphilis per 1000 newborns")+
  ylab("Region")
```
...
data_congenital_table <- data_congenital %>%
  ...
  tab_header(
    title = "Provinces and years with the highest rate of congenital sifilis"
  ) %>%
  tab_footnote(
