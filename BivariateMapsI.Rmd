---
title: "Bivariate maps I - Maternal Syphilis"
author: "CardenasA"
date: "2024-01-24"
...
```
```{r include=FALSE}
rm(data_ins_long, newborn, departamentos)
```
...
datamap <- bi_class(syphilis_residence, x = rate, y = type_residenceRural, style = "quantile", dim = 3)
...
map <- ggplot() +
  ...
  bi_scale_fill(pal = "GrPink", dim = 3) +
  labs(
    title = "Rate of maternal syphilis in pregnants who live in Rural areas"
  ) +
  bi_theme() +
  theme(plot.title = element_text(size = rel(0.65))) 
...
datamap <- bi_class(syphilis_maritalstatus, x = rate, y = marital_statusNonMarried, style = "quantile", dim = 3)
...
map <- ggplot() +
  ...
  bi_scale_fill(pal = "GrPink", dim = 3) +
  labs(
    title = "Rate of maternal syphilis in Non-married pregnants"
  ) +
  bi_theme() +
  theme(plot.title = element_text(size = rel(0.65))) 
...
datamap <- bi_class(syphilis_education, x = rate, y = education_levelNone_Primary, style = "quantile", dim = 3)
...
map <- ggplot() +
  ...
  bi_scale_fill(pal = "GrPink", dim = 3) +
  labs(
    title = "Rate of maternal syphilis in pregnants with primary or no education"
  ) +
  bi_theme() +
  theme(plot.title = element_text(size = rel(0.65))) 
...
map <- ggplot() +
  ...
  bi_scale_fill(pal = "GrPink", dim = 3) +
  labs(
    title = "Rate of maternal syphilis in pregnants without knowledge of Syphilis"
  ) +
  bi_theme() +
  theme(plot.title = element_text(size = rel(0.65))) 
...
syphilis_prenatalcare <- rename(
  syphilis_prenatalcare, "number_prenatal_visits_20_6"="number_prenatal_visits_20-6")
...
datamap <- bi_class(syphilis_prenatalcare, x = rate, y = number_prenatal_visits_20_6, style = "quantile", dim = 3)
...
map <- ggplot() +
  ...
  bi_scale_fill(pal = "GrPink", dim = 3) +
  labs(
    title = "Rate of maternal syphilis in pregnants who have fewer than 6 prenatal care visits"
  ) +
  bi_theme() +
  theme(plot.title = element_text(size = rel(0.65))) 
...
datamap <- bi_class(syphilis_childbirth_provider, x = rate, y = provider_childbirth_2Unskilled, style = "quantile", dim = 3)
...
map <- ggplot() +
  ...
  bi_scale_fill(pal = "GrPink", dim = 3) +
  labs(
    title = "Rate of maternal syphilis in pregnants who were attended by a non-qualified chilbirth provider"
  ) +
  bi_theme() +
  theme(plot.title = element_text(size = rel(0.65))) 
...
datamap <- bi_class(syphilis_prenatal_edu, x = rate, y = prenatal_care_educationNo, style = "quantile", dim = 3)
...
map <- ggplot() +
  ...
  bi_scale_fill(pal = "GrPink", dim = 3) +
  labs(
    title = "Rate of maternal syphilis in pregnants with non-efective prenatal education"
  ) +
  bi_theme() +
  theme(plot.title = element_text(size = rel(0.65))) 
...
datamap <- bi_class(syphilis_prenatal_screening, x = rate, y = prenatal_care_screeningNo, style = "quantile", dim = 3)
...
map <- ggplot() +
  ...
  bi_scale_fill(pal = "GrPink", dim = 3) +
  labs(
    title = "Rate of maternal syphilis in pregnants with non-efective prenatal screening"
  ) +
  bi_theme() +
  theme(plot.title = element_text(size = rel(0.65))) 
