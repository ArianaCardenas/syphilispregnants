...
newborn_distrito <- read_excel("Data_final/Nacidos_vivos_distrito.xls")
...
newborn_dist <- pivot_longer(newborn_distrito, cols = c(4:11), 
                             names_to = "year", values_to = "newborntotal")

newborn_dist$year = as.numeric(newborn_dist$year) 
...
rm(maternal,congenital,newborn,newborn_distrito)
```
...
data_maternal_dist <- data_maternal_dist %>%
  left_join(newborn_dist, by = c("NOMBDEP","NOMBPROV","NOMBDIST","year")) %>%
