...
#Grafico dumbbell provincias

```{r,fig.height=6}
norte_prov = data_grafico_prov%>%
  filter(year==2018|year==2022) %>%
  filter(ZONA=="CENTRO")

ggplot(norte_prov, aes(x = syphilis_screening, y = NOMBPROV)) +
  geom_line() +
  geom_point(aes(color = year), size = 3) +
  xlab("Syphilis screening")+
  ylab("Provincia")
