...
syphilis_year<- svyby(~syphilis_screening,~NOMBDEP+year,svymean,design=design,deff=TRUE,na.rm=TRUE)
syphilis_total<- svyby(~syphilis_screening,~NOMBDEP,svymean,design=design,deff=TRUE,na.rm=TRUE)
...
```{r}
rm(data_grafico_2022, data_grafico_year)
```