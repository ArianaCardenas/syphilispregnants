...
Grafico dumbbell 2014-2022
```{r}
d14_d22 = data_grafico_year %>%
  filter(year==2014|year==2015|year==2016|year==2017|year==2018|year==2019|year==2020|year==2021|year==2022)
  
ggplot(d14_d22, aes(x = syphilis_screening, y = NOMBDEP)) +
  geom_line() +
  geom_point(aes(color = year), size = 3) +
  xlab("Syphilis screening")+
  ylab("Region")
