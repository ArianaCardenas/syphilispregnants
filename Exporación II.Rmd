...
```{r}
residence_total <- svymean(~type_residence, design = mi_diseño, na.rm = TRUE)
print(residence_total)

conf_interval <- confint(residence_total, level = 0.95)
print(conf_interval)
