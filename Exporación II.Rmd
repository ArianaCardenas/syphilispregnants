...
#Total
provider_total <- svymean(~prenatal_care_provider, design=design_total,na.rm=TRUE)
...
#PROVIDER 2010 
provider_2010 <- svymean(~prenatal_care_provider, design_2010,na.rm=TRUE)
...
#PROVIDER 2016 
provider_2016 <- svymean(~prenatal_care_provider, design_2016,na.rm=TRUE)
...
#PROVIDER 2022
provider_2022 <- svymean(~prenatal_care_provider, design_2022,na.rm=TRUE)
...
#Total
size_total <- svymean(~size_final, design=design_total,na.rm=TRUE)
...
#SIZE 2010 
size_2010 <- svymean(~size_final, design_2010,na.rm=TRUE)
...
#SIZE 2016 
size_2016 <- svymean(~size_final, design_2016,na.rm=TRUE)
...
#SIZE 2022
size_2022 <- svymean(~size_final, design_2022,na.rm=TRUE)
...
#Total
weight_total <- svymean(~weight_birth, design=design_total,na.rm=TRUE)
...
#WEIGHT 2010 
weight_2010 <- svymean(~weight_birth, design_2010,na.rm=TRUE)
...
#WEIGHT 2016 
weight_2016 <- svymean(~weight_birth, design_2016,na.rm=TRUE)
...
#WEIGHT 2022
weight_2022 <- svymean(~weight_birth, design_2022,na.rm=TRUE)
