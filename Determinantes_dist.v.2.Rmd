...
poverty_mr = poverty_mr %>%  
  mutate(
    ...
    poverty_cod = case_when(poverty <25 ~ "Under 25%",
                            poverty >=25 & poverty <50 ~ "25% to 50%",
                            poverty >=50 & poverty <=75 ~ "50% to 75%",
                            TRUE ~ "Above 75%")) %>%
...
#DIVIDIR POR 25% Y POR CUARTILES (CADA VARIABLE)
