...
GOALS_2022 <- GOALS_2022 %>% 
  mutate(goal_maternal = ifelse(rest_porcent >= 45, "100",
                                ifelse(rest_porcent >=40 & rest_porcent<45, "90",
                                       ifelse(rest_porcent >=35 & rest_porcent<40, "80",
                                              ifelse(rest_porcent >=30 & rest_porcent <35, "70",
                                                     ifelse(rest_porcent >=25 & rest_porcent <30, "60",
                                                            ifelse(rest_porcent >=20 & rest_porcent <25, "50",
                                                                   ifelse(rest_porcent >=15 & rest_porcent <20, "40",
                                                                          ifelse(rest_porcent >=10  & rest_porcent <15, "30",
                                                                                 ifelse(rest_porcent >=5 & rest_porcent <10, "20",
                                                                                        ifelse(rest_porcent>=0 & rest_porcent<5, "10",
