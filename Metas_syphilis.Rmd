...
GOALS_2022 <- combined_data_2022 %>% 
    ...
    goal3 = ifelse(rest_porcent >=30,1,0),
    
    goals = ifelse(syphilis_screening>=0.95 & congenital_prop<0.50 & rest_porcent>=30, list(c ("Goal 1", "Goal 2", "Goal 3")),
                   ifelse(syphilis_screening<0.95 & congenital_prop>=0.50 & rest_porcent<30, list(c(NA)),
                          ifelse(syphilis_screening>=0.95 & congenital_prop>=0.50 & rest_porcent<30, list(c("Goal 1")),
                                 ifelse(syphilis_screening<0.95 & congenital_prop<0.50 & rest_porcent<30, list(c("Goal 2")),
                                        ifelse(syphilis_screening<0.95 & congenital_prop>=0.50 & rest_porcent>=30, list(c("Goal 3")),
                                               ifelse(syphilis_screening>=0.95 & congenital_prop<0.50 & rest_porcent<30, list(c("Goal 1", "Goal 2")),
                                                      ifelse(syphilis_screening>=0.95 & congenital_prop>=0.50 & rest_porcent>=30, list(c("Goal 1", "Goal 3")),
                                                             ifelse(syphilis_screening<0.95 & congenital_prop<0.50 & rest_porcent>=30, list(c("Goal 2", "Goal 3")), NA)
               ))))))))
...
figure_2b1 <- ggplot() +
  geom_sf(data = GOALS_2022, aes(geometry = geometry, fill = goal_screening), col = "#FAEBD7") +
  scale_fill_gradient(
    high = "darkred", 
    low = "darkgoldenrod1", 
    limits = c(0,100), 
...
figure_2b2 <- ggplot() +
  geom_sf(data = GOALS_2022, aes(geometry = geometry, fill = goal_congenital), col = "#FAEBD7") +
  scale_fill_gradient(
    high = "darkred", 
    low = "darkgoldenrod1", 
    limits = c(0,100), 
