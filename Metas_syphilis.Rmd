...
GOALS_2022 <- GOALS_2022 %>% 
  mutate(goal_maternal = ifelse(rest_porcent >= 30, "100",
                                ifelse(rest_porcent >=27 & rest_porcent<30, "90",
                                       ifelse(rest_porcent >=24 & rest_porcent<27, "80",
                                              ifelse(rest_porcent >=21 & rest_porcent <24, "70",
                                                     ifelse(rest_porcent >=18 & rest_porcent <21, "60",
                                                            ifelse(rest_porcent >=15 & rest_porcent <18, "50",
                                                                   ifelse(rest_porcent >=12 & rest_porcent <15, "40",
                                                                          ifelse(rest_porcent >=9  & rest_porcent <12, "30",
                                                                                 ifelse(rest_porcent >=6 & rest_porcent <9, "20",
                                                                                        ifelse(rest_porcent>=3 & rest_porcent<6, "10",
                                                                                               ifelse(rest_porcent < 3, "0", NA))))))))))))
