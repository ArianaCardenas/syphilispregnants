...
National_obj2 <- National_obj2 +
  ggtitle("Objective Two - National") +
  theme(
...
National_obj3  <- National_obj3  +
  ggtitle("Objective Three - National") +
  theme(
    plot.title = element_text(size = 10),  
    legend.position = "bottom", 
    legend.justification = "center") +
...
Sierra_obj3  <- Sierra_obj3  +
  ggtitle("Objective Three - Sierra") +
  theme(
    plot.title = element_text(size = 10),  
    legend.position = "bottom", 
    legend.justification = "center") +
...
combined_plot <- National_obj2 + Costa_obj2 + Sierra_obj2 +  Selva_obj2 + National_obj3 + Costa_obj3 + Sierra_obj3 + Selva_obj3 +
  plot_layout(ncol = 4, guides = 'collect') &  
  theme(legend.position = 'bottom')

Poverty_graph  <- combined_plot + 
  plot_annotation(
    title = "Objectives by Poverty", 
    theme = theme(
