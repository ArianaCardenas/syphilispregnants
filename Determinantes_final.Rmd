...
```{r}
selected_colors <- wes_palette("Zissou1", n = 5)[c(3, 1, 5)]
```
...
National_graph
ggsave("./Figures/National.png", plot = National_graph)
```

```{r}
#Nueva opción para guardar figuras*

Determinantes_reg <-cowplot::plot_grid(Poverty_graph, Education_graph, Prenatal_graph, ncol = 1, 
                                       labels = c("a", "b", "c"), label_size = 20)

print(Determinantes_reg)

ggsave("Determinantes_reg.png", plot = Determinantes_reg, width = 15, height = 20, dpi = 300)
```
