...
Poverty_graph  <- combined_plot + 
  plot_annotation(
    title = "Trends of Syphilis in Peru by Poverty", 
    theme = theme(
...
Education_graph  <- combined_plot + 
  plot_annotation(
    title = "Trends of Syphilis in Peru by Education", 
    theme = theme(
      plot.title = element_text(size = 14, hjust = 0.5, face = "bold")
    )
  )
