...
mappoverty_MS <- map_poverty | map15 | map18 |map22 | (legend/plot_spacer())
...
mapeducation_MS <- map_education | map15 | map18 |map22 | (legend/plot_spacer())
 #+ plot_layout(widths = c(1, 1, 1, 1, 1))
...
mapprecare_MS <- map_precare | map15 | map18 |map22 | (legend/plot_spacer())
 #+ plot_layout(widths = c(1, 1, 1, 1, 1))
...
maptotals_maternal <- (map_poverty | legend_poverty | map_education | legend_education | map_precare | legend_precare) + plot_layout(widths = c(1, 0.4, 1, 0.4, 1, 0.4)) 
...
maptotalsfinal <-cowplot::plot_grid(maptotals, maptotals_maternal, ncol = 1, 
                                       labels = c("a. Congenital Syphilis", 
                                                  "b. Maternal Syphilis"), label_size = 15)

print(maptotalsfinal)

```
```{r}
#ggsave("Figures/Bivariatemapstotal.png", plot = maptotalsfinal, width = 10, height = 7, dpi = 300)
```

```{r, echo = FALSE,fig.height = 8, fig.width = 8}
mapssupplementary1 <-cowplot::plot_grid(mappoverty_CS, mapeducation_CS, mapprecare_CS, 
                                        ncol = 1, 
                                       labels = c("a", 
                                                  "b", 
                                                  "c"), label_size = 20)
...
mapssupplementary1 = plot_grid(
  title, mapssupplementary1,
  ncol = 1,
  # rel_heights values control vertical title margins
  rel_heights = c(0.1, 1)
)

print(mapssupplementary1)

```
```{r, echo = FALSE,fig.height = 8, fig.width = 8}
mapssupplementary2 <-cowplot::plot_grid(mappoverty_MS, mapeducation_MS, mapprecare_MS, 
                                        ncol = 1, 
                                       labels = c("d", 
                                                  "e", 
                                                  "f"), label_size = 20)
...
mapssupplementary2 = plot_grid(
  title, mapssupplementary2,
  ncol = 1,
  # rel_heights values control vertical title margins
  rel_heights = c(0.1, 1)
)

print(mapssupplementary2)

```

```{r, echo = FALSE,fig.height = 14, fig.width = 7}
mapssupplementaryfinal <-cowplot::plot_grid(mapssupplementary1, mapssupplementary2, 
                                        ncol = 1)

print(mapssupplementaryfinal)

```

```{r}
#ggsave("Figures/BivariatemapsSup.png", plot = mapssupplementaryfinal, width = 7, height = 14, dpi = 300)
```
