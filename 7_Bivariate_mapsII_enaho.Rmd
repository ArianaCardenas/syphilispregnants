...
precare = 
  data_enaho %>%
  left_join(data_maternal_dep, by = c("year","NOMBDEP")) %>%
  select(control_iron,year,NOMBDEP,conglome,estrato,facpob07,rate_mat) %>%
...
datamap <- bi_class(syphilis_precare, x = rate_mat, y = control_ironno, style = "quantile", dim = 2)
...
datamap <- bi_class(syphilis_precare15, x = rate_mat, y = control_ironno, style = "quantile", dim = 2)
...
datamap <- bi_class(syphilis_precare18, x = rate_mat, y = control_ironno, style = "quantile", dim = 2)
...
datamap <- bi_class(syphilis_precare22, x = rate_mat, y = control_ironno, style = "quantile", dim = 2)
