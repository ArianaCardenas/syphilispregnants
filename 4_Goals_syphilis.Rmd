...
```{r}
#Goal 1: Rate of Congenital syphilis < 0.5 per 1000 individuals
...
```{r}
#Goal 2: Decreade in maternal syphilis by 30% between 2018 - 2022

##Correr el rmd de Syphilis_materna
...
#Correr el rmd de Syphilis_screening_final
...
#Nueva opción para guardar figuras*
```{r}
...
print(figure2)
ggsave("Goals_2022.png", plot = figure2, width = 8, height = 8, dpi = 300)
```
